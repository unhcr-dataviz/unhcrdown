...
author: "Your name"
institute: "Your bureau"
date: "`r format(Sys.Date(),  '%d %B %Y')`"
output:
  unhcrdown::xaringan_presentation:
    lib_dir: libs
    nature:
...
Provides an R Markdown output format `unhcrdown::xaringan_presentation` as a wrapper for remark.js, and you can use it in the YAML metadata, e.g.
